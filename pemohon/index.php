		...
		<tr  >
			...
			<tr>
				...
				switch ($page) {
					...
					case 'formulir': include "pages/formulir.php"; break;
					case 'status'	: include "pages/status.php"; break;
					case 'pembayaran' : include "pages/pembayaran.php"; break;
		...
		<tr>
			...
			<table width="101%" border="0" align="center" valign="middle">
				...
				<tr id="utama"> <td>
					...
					<tr id="utama"> <td >
						<strong><img src="asset/tambah.png" width="30" height="30" align="middle"> 
						<a href="index.php?page=formulir" title="Tambah Data Pemohon" style="text-decoration: none;" ><font color="white">ISI FORMULIR&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></a></strong><br> 
					 </td>
					</tr>                
				<tr id="utama"> <td>
					<strong><img src="asset/lihat.png" width="30" height="30" align="middle"> 
					<a href="index.php?page=status" title="Lihat Status" style="text-decoration: none;" ><font color="white">LIHAT STATUS</font><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></a></strong><br> 
					 </td>
				</tr>
					<tr id="utama"> <td>
						<strong><img src="asset/save.png" width="30" height="30" align="middle">
						PEM<a href="index.php?page=pembayaran" title="Bayar" style="text-decoration: none;" ><font color="white">BAYARAN</font><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></a></strong><br>
						</td>
					</tr>
				<tr id="utama"> <td>
